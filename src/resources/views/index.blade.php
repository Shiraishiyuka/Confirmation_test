        ...
        <div class="form_box">
            ...
            <div class="group-gender">
                <div class="radio_group">
                    <label class="gender"><input type="radio" name="gender" class="check" value="男性" checked/>男性</label></div>
                    <div class="radio_group">
                    <label class="gender"><input type="radio" name="gender" class="check" value="女性" />女性</label></div>
                    <div class="radio_group">
                    <label class="gender"><input type="radio" name="gender" class="check" value="その他" />その他</label></div>
            </div>
            ...
            <div class="group-inquiry">
                     <select name="inquiry" class="inquiry">
                        <option value="{{ old('inquiry') }}" disabled selected style="display:none;">選択してください</option>
            ...
            <div class="form__input--form-textarea">
                     <textarea name="content"  class="content" placeholder="お問合せの内容をご記載ください" value="{{ old('content') }}"></textarea>
            </div>
            </div>
            <div class="form__error">
                    @error('content')
